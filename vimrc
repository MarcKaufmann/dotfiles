...
" Quick pdf creation
nnoremap <Leader>p :Pandoc --template=~/Git/grand-schemer/latex/latex.template pdf<cr>
nnoremap <Leader>r :Pandoc --template=~/Git/grand-schemer/latex/marc.beamer beamer<cr>
